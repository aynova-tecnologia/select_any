...
class MySnackBar extends StatefulWidget implements SnackBar {
  ...
  const MySnackBar({
    ...
    bool? persist,
        ...
        assert(
          placement == null || behavior == SnackBarBehavior.floating,
  ...
  @override
  double? get actionOverflowThreshold => null;

  @override
  HitTestBehavior? get hitTestBehavior => null;

  @override
  bool get persist => _persist ?? false;
}
...
class _MySnackBarState extends State<MySnackBar> {
  ...
  void didUpdateWidget(SnackBar oldWidget) {
    ...
    super.didUpdateWidget(oldWidget as MySnackBar);
  }
